...
const Minigames = (() => {
  ...
  const GAMES = [
    ...
    () => gridClick({
      ...
      cols: 4,
      items: shuffle([
        { label: '<span class="bean fresh">🫘</span>', bad: false }, { label: '🪲', bad: true },
        { label: '<span class="bean fresh">🫘</span>', bad: false }, { label: '<span class="bean fresh">🫘</span>', bad: false },
        { label: '<span class="bean stale">🫘</span>', bad: true },  { label: '<span class="bean fresh">🫘</span>', bad: false },
        { label: '<span class="bean fresh">🫘</span>', bad: false }, { label: '<span class="bean broken">💔</span>', bad: true },
        { label: '<span class="bean fresh">🫘</span>', bad: false }, { label: '<span class="bean fresh">🫘</span>', bad: false },
        { label: '<span class="bean fresh">🫘</span>', bad: false }, { label: '<span class="bean fresh">🫘</span>', bad: false },
      ]),
    }),
